...
```git
git clone https://github.com/<your_github_username>/tomper-wear-ecommerce-backend.git
```

**Step 4:** Go inside cloned folder and add the original repository as `upstream`:

```git
git remote add upstream https://github.com/varunKT001/tomper-wear-ecommerce-backend.git
```
